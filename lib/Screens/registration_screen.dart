import 'package:bus_pedal/Screens/home_screen.dart';
 ...
 //our form key
  ...
  Widget build(BuildContext context) {
    ...
    final firstNameField = TextFormField(
        ...
        validator: (value) {
          RegExp regex = new RegExp(r'^.{3,}$');//minimum value for firebase is 6 for password
          if(value!.isEmpty)
          {
    ...
    final secondNameField = TextFormField(
        ...
        keyboardType: TextInputType.name,
        validator: (value) {
          //minimum value for firebase is 6 for password
          if(value!.isEmpty)
          {
